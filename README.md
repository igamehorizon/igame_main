...
NPC Interactions & Dialogues – An LLM-based toolkit for Unity that generates 
persona-driven NPC conversations, with traits and dialogue auto-extracted from the Game Design Document (GDD).
